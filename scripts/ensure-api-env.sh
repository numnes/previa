...
# shellcheck source=lib/work-root.sh
source "${ROOT_DIR}/scripts/lib/work-root.sh"
...
work_root="$(previa_sync_work_root_env "$ROOT_DIR")"
...
# PREVIA_WORK_ROOT / PREVIA_CORE_DIR already written by previa_sync_work_root_env.
